...
export interface ApiDoctorProfileDoctorProfile
  ...
  info: {
    description: 'Doctor profile linked to a Strapi user for SmileCare login';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Role: Schema.Attribute.Enumeration<['doctor', 'admin', 'staff']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'doctor'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
